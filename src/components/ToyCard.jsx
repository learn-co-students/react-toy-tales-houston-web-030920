  ...
  render() {
    return (
      <div className="card">
        ...
        <button className="like-btn" onClick={() => this.handleLike(this.state.id)}>Like {'<3'}</button>
        <button className="del-btn" onClick={() => this.props.deleteToy(this.state)}>Donate to GoodWill</button>
      </div>
    );
  }
